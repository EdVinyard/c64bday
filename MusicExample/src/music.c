...
void multiple_voice_example() {
    ...
    for (i = 0; i < sizeof(single_voice_data); i += 3) {
        ...
        SID_REGISTERS[4] = 33; // voice 1 sawtooth (32) + attack initiated (1)
        ...
        SID_REGISTERS[4+7] = 33; // voice 2 sawtooth (32) + attack (1)
        ...
        SID_REGISTERS[4] = 32; // voice 1 decay initiated
        SID_REGISTERS[4+7] = 32; // voice 2 decay initiated
